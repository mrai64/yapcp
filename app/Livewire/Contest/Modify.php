...
class Modify extends Component
{
    ...
    public function mount( string $cid) // named cid as in Route
    {
        ...
        $this->day_1_opening            = $this->contest->day_1_opening;
        $this->day_2_closing            = $this->contest->day_2_closing;
        $this->day_3_jury_opening       = $this->contest->day_3_jury_opening;
        $this->day_4_jury_closing       = $this->contest->day_4_jury_closing;
        $this->day_5_revelations        = $this->contest->day_5_revelations;
        $this->day_6_awards             = $this->contest->day_6_awards;
        $this->day_7_catalogues         = $this->contest->day_7_catalogues;
        $this->day_8_closing            = $this->contest->day_8_closing;
     ...
     */
    public function updateContestMain(){
        ...
        $this->contest->url_4_catalogue          = $validated['_url_4_catalogue'];
        ...
        // redirect
        return redirect()
          ->route('organization-dashboard', ['oid' => $this->contest->organization_id ])
          ->with('success', __('Contest updated, enjoy!') );
        //
    }
}
