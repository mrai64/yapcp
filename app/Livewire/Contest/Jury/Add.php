...
class Add extends Component
{
    ...
    public function mount(string $sid) // as indicate in route section_id
    {
        ...
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' '. json_encode($this->section) );
        ...
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' '. $this->contest_id );
        ...
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' contest: ' . json_encode($this->jury_opening) );
        $this->jury_closing  = $this->contest->day_4_jury_closing->format("Y-m-d");
        $this->jury_closing .= ' 23:59:59';
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' contest: ' . json_encode($this->jury_closing) );

        $this->contest_section_list = ContestSection::where('contest_id', $this->contest_id )->get();
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ . ' ' . __LINE__ . ' contest_section_list: ' . $this->contest_section_list);
        ...
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ . ' ' . __LINE__ . ' contest_section_list: ' . json_encode($this->contest_section_list) );
    ...
    */
    public function add_contest_juror()
    {
        ...
        if ($is_in_user_contact === 0) {
            Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' try to insert ' );
            ...
            Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' user:' . json_encode($juror) );
            ...
            Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' user_contact:' . json_encode($juror_contact) );

        } else {
            Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ .':'. __LINE__ . ' found ' );
        ...
        // add to userRole or update to avoid dup line 
        Log::info( 'Component ' . __CLASS__ .' '.__FUNCTION__ . ' ' . __LINE__. ' user->id: '. $juror->id);
        // $juror_role = UserRole::create(['user_id' => $juror->id, 'role' => 'juror', 'contest_id' => $this->contest_id]);
