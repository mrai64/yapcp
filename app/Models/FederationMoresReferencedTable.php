...
/**
 * @method static \Database\Factories\FederationMoresReferencedTableFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\Database\Factories\FederationMoresReferencedTableFactory> */
    use HasFactory;
}
