 ...
 * User Role factory
 * 
 * A user is related with 
 * - an organization as member, president, secretary and so on
 * and / or
 * - a federation as member, president, secretary and so on
 * and / or
 * - a contest as chairman, juror and so on
 * To build a valid User Role record we need to find
 * - a user
 * - an organization or a federation or a contest
 * - a role
