...
Route::get( '/organization/contest/section_works/{sid}', Organization\Contest\Section::class,   ['sid'])->middleware(['auth', 'verified'])->name('organization-contest-section-list');
