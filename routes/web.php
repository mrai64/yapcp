...
Volt::route('/organization/design/contest-patronage/modify/{contest_patronage}', 'organization.design.contest-patronage.modify')
    ->middleware(['auth', 'verified']) // authorize in mount() was: ", 'can:modify,contest_patronage,contest'])"
...
Volt::route('/organization/design/contest-jury/modify/{contest_jury}', 'organization.design.contest-jury.modify')
    ->middleware(['auth', 'verified'])
    ->name('organization.design.contest-jury.modify');
...
Volt::route('/admin/backup/user-work/{backuppedUser}', 'admin.backup.user-work')
    ->middleware(['auth', 'verified', 'can:access-admin'])
