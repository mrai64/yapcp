# (A) feat: Galleria UserWork basata su miniature

> **Branch:** `feat/0161-user_work-listed2`  
> **Stato:** Chiuso
> **priorità:** A  
> **id assegnato:** 2026-08-06.03  
> **Titolo e urgenza:** (A) feat: UserWork listed as miniature grid  
> **Project/issue link:** [#161](https://github.com/mrai64/yapcp/issues/161)
...
- **Filtro e Ordinamento:** Vengono estratti solo i record associati all'utente correntemente autenticato (`Auth::id()`). L'ordinamento primario è alfabetico su `title_en` (`asc`), mentre l'ordinamento secondario è basato sulla data di ultimo aggiornamento `updated_at` (`desc`). La paginazione è impostata a 12 elementi per pagina.
...
- la visualizzazione paginata non si basa su un elenco di titoli ma su una griglia di miniature.
