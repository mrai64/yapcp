...
> **Branch:** `fix/0326-contest-jury-uuid`  
> **Stato:** Chiuso  
> **priorità:** A  
> **id assegnato:** 2026-09-16.03  
> **Titolo e urgenza:** (A) fix: ContestAward / uuid booted  
> **Project/issue link:** [#326](https://github.com/mrai64/yapcp/issues/326)  
...
Corretto l'evento creating all'interno del metodo statico `booted()` del model ContestAward.
...
È stato sostituito con la funzione standard newUniqueId(), che viene richiamata solo quando l'id è mancante `if (empty($model->id))` per garantire che un nuovo UUID v7 venga generato e assegnato, allineando il comportamento del model ContestAward a quello già presente in User.
