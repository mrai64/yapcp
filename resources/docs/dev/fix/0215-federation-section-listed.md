...
> **Titolo e urgenza:** (A) fix: FederationSection / Lista sezioni non gestisce gruppo admin  
...
Problema: la lista delle FederationSection non effettuava distinzione tra utenti amministratori e utenti normali, non esponendo i link di azione (Aggiungi / Modifica / Rimuovi) agli utenti amministratori.
