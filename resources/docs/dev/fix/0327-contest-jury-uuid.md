...
> **Branch:** `fix/0327-contest-jury-uuid`  
> **Stato:** Chiuso  
> **priorità:** A  
> **id assegnato:** 2026-09-16.04  
> **Titolo e urgenza:** (A) fix: ContestJury / uuid booted  
> **Project/issue link:** [#327](https://github.com/mrai64/yapcp/issues/327)  
...
Corretto l'evento creating all'interno del metodo statico `booted()` del model ContestJury.
...
È stato sostituito con la funzione standard newUniqueId(), che viene richiamata solo quando l'id è mancante `if (empty($model->id))` per garantire che un nuovo UUID v7 venga generato e assegnato, allineando il comportamento del model ContestJury a quello già presente in User.
