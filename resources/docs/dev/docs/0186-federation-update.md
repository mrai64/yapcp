...
> **Branch:** `docs/0186-federation-update`  
> **Stato:** Chiuso  
> **priorità:** A  
> **id assegnato:** 2026-08-15.06  
> **Titolo e urgenza:** (A) docs: documentazione form di modifica e validazione per Federation (admin group)  
> **Project/issue link:** [#186](https://github.com/mrai64/yapcp/issues/186)  
...
- **Componente Livewire Volt:** Implementato come Single File Component (SFC) anonimo in `resources/views/livewire/federation/modify.blade.php` (`new class extends Component`).
