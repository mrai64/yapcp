...
- [Phone messages](#cell-numbers)
- [Show your portfolios](#show-your)
- [One more...](#one-more)
...
email. Are you the ONLY AND UNIQUE John Smith in USA? No?
So we ask also you the postal address, and other info.
Some of that infos remain *reserved for yaPCP* to communicate with you thru
email, sms, or whatsapp.

Here we reunite your personal contact infos, these are the data
we use to send your participation to any Contest hosted in yaPCP,
...
the link that put you ono first panel.  
...
![User Contact Modify 1st ](/docs/users/contact_infos/modify1_img01.png)
