...
a specifical url is inserted to consent access thru platform to
...
![__](/docs/admin/backup/userwork_img01.png)

&nbsp;

Then pass to User Index List or use the Backup Run link (for all user)
![__](/docs/admin/backup/userwork_img02.png)
...
![__](/docs/admin/backup/userwork_img05.png)
...
![__](/docs/admin/backup/userwork_img07.png)
