...
new class extends Component {
    ...
    public function rules()
    {
        ...
        'contestAwardAwardCode'   => 'required|uppercase:max:10',
    ...
    public function addContestAward()
    {
        ...
        $contestAward = ContestAward::updateOrCreate(
            [
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form wire:submit="addContestAward">
                    ...
                    <!-- Real Prize, or less -->
                    <div class="mb-4">
                        <x-input-label for="contestAwardIsAward" :value="__('Really Award, or less?')" />
                            <x-checkbox wire:model="contestAwardIsAward" id="contestAwardIsAward" name="contestAwardIsAward" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" />
                            {{ __('Yes, it´s a real prize') }}
                        </label>
