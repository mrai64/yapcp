        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form wire:submit="modifyFederationSection">
                ...
                <div class="mb-4">
                    ...
                    <p class="small">
                        {{ __('Code is key, instead of change code you must insert a new record, then delete that.') }}
                    </p>
                </div>
                <!--/federation-section code -->
                ...
                <div class="mb-4">
                    <x-input-label for="short_size_max" :value="__('Max size for shortest side - px from 1080 to 2500')" />
                ...
                <div class="mb-4">
                    <x-input-label for="long_size_max" :value="__('Max size for longest side - px from 1080 to 4000')" />
                ...
                <div class="mb-4">
                    <x-input-label for="file_size_max" :value="__('Max size for file size - B from 100000 to 6000000')" />
