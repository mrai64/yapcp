        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form wire:submit="modifyFederationSection">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input wire:model="minWorks" id="minWorks" class="block mt-1 w-48" type="number" name="minWorks" required placeholder="{{ __('Integer, from 0 to 20') }}" min="0" max="20" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input wire:model="maxWorks" id="maxWorks" class="block mt-1 w-48" type="number" name="maxWorks" required placeholder="{{ __('Integer, from 1 to 20') }}" min="0" max="20" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input wire:model="shortSizeMax" id="shortSizeMax" class="block mt-1 w-48" type="number" name="shortSizeMax" required placeholder="{{ __('Integer, from 1 to 20') }}" min="1080" max="2500" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input wire:model="longSizeMax" id="longSizeMax" class="block mt-1 w-48" type="number" name="longSizeMax" required placeholder="{{ __('Integer, from 1 to 20') }}" min="1080" max="2500" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input wire:model="fileSizeMax" id="fileSizeMax" class="block mt-1 w-48" type="number" name="fileSizeMax" required placeholder="{{ __('Integer, from 100000     to 6000000') }}" min="100000" max="6000000" />
