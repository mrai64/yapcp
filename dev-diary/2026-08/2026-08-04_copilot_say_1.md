...
2) Verifica il guard / utente effettivamente autenticato al momento della chiamata
...
3) Conferma che il modello Federation passato alla Policy sia quello giusto
...
4) Isola la chiamata al Gate manualmente (Tinker)
...
5) Controlla altri middleware della route (verified, auth, livewire, ecc.)
...
6) Cerca chiamate duplicate / Gate::before che potrebbero negare
...
7) Esamina il flusso Livewire / Volt — differenze fra route classica e class-based
...
8) Log dettagliato su eccezione AuthorizationException
...
9) Verifica la registrazione della Policy
...
10) Ultima risorsa: sostituisci temporaneamente middleware con authorize() nel controller o mount
