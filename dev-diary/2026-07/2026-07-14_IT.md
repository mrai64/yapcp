...
| [<< ieri](./2026-07-08_IT.md)           | [index](../index.md)           | [domani >>](./2026-07-15_IT.md)                       |
...
[docs/1.0](/resources/docs/1.0/index.md)  
...
Si tratta per l'utente di definire cosa deve fare la piattaforma per le operazioni
base: registrazione, conferma email, login.  
Quindi devo realizzare dei test per verificare che la piattaforma risponda
su questo e definire così una prima milestone M1
arrivando a completarla entro una data.  
Questo può diventare un thread indipendente e poi finire PR in 0140
invece che in main/master.  
Verificare che in project 1 e in lista "per dopo" non ci siano
issue che vengono risolte.
