...
Una delle cose che ho notato è che i nomi delle variabili sono "semplici", camelCase ma senza - e _.
Caspita, con $userWorks al posto di $this->user_works_set **FUNZIONA**

Ma porcoggiudabalengo, perché non lo scrivono a caratteri cubitali che i nomi delle
variabili **DEVONO** seguire uno standard *camelCase* e non *snake_case*?
