...
Serve rilanciare il caricatore di works che ora è [d_ParticipantSeeder](/database/seeders/d_ParticipantSeeder.php)
Ma c'è un intoppo, il nomefile deve coincidere con il nome di una classe.
