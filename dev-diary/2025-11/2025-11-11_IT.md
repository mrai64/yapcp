...
delle concatenazioni eleganti da mettere giù. Dall'altra delle prestazioni
...
I dati che c'erano e vorrei ci fossero: tutto work, ma anche contest_works.id
e i dati dell'autore (siamo in organizzazione)

```sql
bind :section_id (ci sono i prefissi)
...
AH! per inciso MAMP funziona, serve cliccare sulla pagina [public](http://127.0.0.1:8888/yapcp/public/),
ma poi funziona.

## LARAVELDAY a Verona 20 nov 2025 ore 9 Hotel San Marco

Solo su prenotazione.

### Next step

caricati i lavori in sezione devo metterli tra i verificati
e riempire le votazioni dei giurati con dei valori random
come i tiri a dadi, se il voto va fino a 30 fare 6
"tiri di dado" e se il totale va oltre, fermarlo a 30.

C'è anche da fare la pagina in cui  fare +1 -1 su un set
di lavori ristretto, quelli che se ci sono tutti
la §% di ammessi è troppo ampia, se mancano tutti
è invece troppo scarsa.

## ContestVotesSeeders

* Prendere una section e verificare che sia di un concorso aperto
* prendere l'elenco dei giurasti legati a quella section
* per tutti i lavori che sono nella contest_works e per tutti i giurati
  andare a fare 6 lanci di voti da 4 a 6, il totale se supera 30 viene
  limitato a 30/30.
