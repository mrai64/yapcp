...
Ho acceso (per l'ultma volta? mai dire mai) MAMP, quello che avevo 
maneggiato per aggiornamenti sia su mysql che su php che su phpadmin
(in pratica 3 su 3 di quel che uso).

Sostituito da 3 app 3: server Herd, server dbngin, forntend sequel-ace.
